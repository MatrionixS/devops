    ...
    stages {
       stage("init") {
        ...
        stage("Commit version update") {
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'github-credentials', gitToolName: 'Default')]) {
                        ...
                        sh 'git remote set-url origin "https://github.com/MatrionixS/devops.git'
                        sh 'git add .'
